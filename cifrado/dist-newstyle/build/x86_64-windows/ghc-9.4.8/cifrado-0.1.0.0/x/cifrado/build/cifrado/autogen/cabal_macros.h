...
/* package cifrado-0.1.0.0 */
#ifndef VERSION_cifrado
#define VERSION_cifrado "0.1.0.0"
#endif /* VERSION_cifrado */
#ifndef MIN_VERSION_cifrado
#define MIN_VERSION_cifrado(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cifrado */
...
#define CURRENT_COMPONENT_ID "cifrado-0.1.0.0-inplace-cifrado"
